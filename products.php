  ...
  <head>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="index.html" class="logo">Online <em> Supermarket</em></a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            ...
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="discounts_and_promos.php">Discounts and Promos</a>
                                </div>
                            </li>
    ...
    <nav>
      ...
      <!--    <a class="page-link" href="#" aria-label="Previous">
        ...
        <li class="page-item"><a class="page-link" href="#">View all Products</a></li>
        <!--<li class="page-item">
                ...
                <div class="col-lg-4">
                    <div class="trainer-item">
                        ...
                        <div class="down-content">
                            <!-- <span>
                                <del><sup>$</sup>15.00</del> <sup>$</sup>1-7.00
                            </span>-->
                            <br>
                            <h4>Beverages</h4>
                            ...
                            <ul class="social-icons">
                                <li><a href="product-details.php">+ See Products</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
